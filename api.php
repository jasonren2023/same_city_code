...
//            file_put_contents("./data/wlww_qr.log", var_export($message, true) . PHP_EOL, FILE_APPEND);
            if($message['event'] == 'MASSSENDJOBFINISH'){
                pdo_update('wlmerchant_goods_freepublish',array('articleinfo' => $message['articleurlresult']['resultlist']['item']['articleurl']),array('msg_id' => $message['msgid']));
                exit('success');
            }
